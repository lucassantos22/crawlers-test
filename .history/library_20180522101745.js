...
// driver.findElement(By.xpath('//table')).then(element => {
//     console.log('achou o table!');
// });

// driver.findElement(By.xpath('//table//div[@id="xulapa"]'))
//     .then(element => {
//         console.log('achou a xulapa!');
//     })
//     .catch(error => {
//         console.log('nada de xulapa', error);
//     })
