...
driver.findElement(By.id("//input[@class='nome']")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='E-mail']")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='veiculo']")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='jftextbox'][1]")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='jftextbox'][2]")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='telefone']")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='telefone']")).sendKeys('Teste');
driver.findElement(By.id("//input[@class='mensagem']")).sendKeys('Teste');
