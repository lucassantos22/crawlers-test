...
driver.findElement(By.xpath('//div[@id="glossarysearchheading"]/parent::form/input[@id="glossarysearchword"]')).sendKeys('Glossário');
driver.findElement(By.xpath('//div[@id="glossarysearchheading"]/parent::form/input[@id="glossarysearchword"]')).sendKeys(webdriver.Key.ENTER);
