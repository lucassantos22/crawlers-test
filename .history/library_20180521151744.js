var webdriver = require('selenium-webdriver'),
    ...
    driver.findElement(webdriver.By.Name('telefoneId')).sendKeys('Lucas');
    driver.findElement(webdriver.By.Name('enderecoId')).sendKeys('Lucas');
    driver.findElement(webdriver.By.Name('profissaoId')).sendKeys('Lucas');
