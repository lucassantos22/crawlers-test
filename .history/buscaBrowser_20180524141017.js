...
driver.findElement(By.id("//label[@class='nome']")).sendKeys('Teste');
driver.findElement(By.id("//label[@class='E-mail']")).sendKeys('Teste');
driver.findElement(By.id("//label[@class='veiculo']")).sendKeys('Teste');
driver.findElement(By.id("//label[@class='jftextbox'][1]")).sendKeys('Teste');
driver.findElement(By.id("//label[@class='jftextbox'][2]")).sendKeys('Teste');
driver.findElement(By.id("//label[@class='telefone']")).sendKeys('Teste');
