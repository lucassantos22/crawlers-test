...
let Idade = driver.findElement(By.name('idade')).sendKeys('18');
let Telefone = driver.findElement(By.name('telefone')).sendKeys('984791311');
let Endereço = driver.findElement(By.name('endereco')).sendKeys('Rua Desembargador');
let Profissão = driver.findElement(By.name('profissao')).sendKeys('Desenvolvedor');
