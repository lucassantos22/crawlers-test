const webdriver = require('selenium-webdriver'),
    ...
    driver.findElement(By.name('idade')).sendKeys('44');
    driver.findElement(By.name('telefone')).sendKeys('984794478');
    driver.findElement(By.name('endereco')).sendKeys('Rua Chilipa');
    driver.findElement(By.name('profissao')).sendKeys('Dentista');
    driver.findElement(By.id('btn')).click();
